        ...
        <div className="login__conteiner">
          ...
          <form className="login__form">
            <label className="login__form-field">
              ...
              <input type='email' className="login__input login__input_type_email" id="login-input-email" name='email' required></input>
              <span className="login__input-error input-email-error"></span>
            </label>
            <label className="login__form-field">
              <span className="login__input-placeholder">Пароль</span>
              <input type='password' className="login__input login__input_type_password" id="login-input-password" name='password' required></input>
